...
urlpatterns = [
    ...
    url(r'^(?P<id>[0-9]+)/edit_income$', views.edit_income, name='edit-income'),
    url(r'^(?P<id>[0-9]+)/delete_income$', views.delete_income, name='delete-income'),
    url(r'^(?P<id>[0-9]+)/add_cost/$', views.add_cost, name='add_cost'),
    url(r'^(?P<id>[0-9]+)/edit_cost$', views.edit_cost, name='edit-cost'),
    url(r'^(?P<id>[0-9]+)/delete_cost$', views.delete_cost, name='delete-cost'),
    ]